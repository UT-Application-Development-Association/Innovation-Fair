...
var dict = {
    'zh': {
        ...
        "about-intro-1": "IF2020是什么？",
        "about-intro-2": "Innovation Fair 2020将有三个主题,分别是:人工智能,大学生活和后疫情时代。参赛者们将围绕着这三个主题进行头脑风暴,开发出一个专属于自己队伍的应用,并展示应用原型。同时,专业评审会对参赛作品进行点评并提供建议,让参赛者们收获在应用开发上的宝贵经验。在此之外,本次活动还提供一个与各行业精英对话的平台,让参赛者获取有关事业与学术方面的建议。这不只是一场比赛,也是给有丰富想象力并且愿意实践自己想法的同学们提供在课余时间锻炼自己的机会。",
